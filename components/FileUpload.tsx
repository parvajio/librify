...
const authenticator = async () => {
  try {
    const res = await fetch(`${config.env.prodApiEndpoint}/api/imagekit`);
...
const FileUpload = ({
  ...
  const onError = (error : any) => {
    ...
    toast({
      ...
      description: `Your img could not be uploaded. Please try again. ${error}`,
      variant: "destructive",
    });
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className={cn("text-base", styles.placeholder)}>Upload file</p>
